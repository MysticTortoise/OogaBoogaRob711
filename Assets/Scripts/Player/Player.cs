...
public class Player : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Grounded Check
        grounded = Physics2D.OverlapBox((Vector2)boxCollider.bounds.center - new Vector2(0, boxCollider.bounds.size.y * 0.5f), new Vector2(boxCollider.bounds.size.x * .98f, 1), 0, boxCollider.includeLayers);
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawWireCube((Vector2)boxCollider.bounds.center - new Vector2(0, boxCollider.bounds.size.y * 0.5f), new Vector2(boxCollider.bounds.size.x * 0.98f, 1f));
